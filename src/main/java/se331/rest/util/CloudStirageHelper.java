...
@Component
public class CloudStirageHelper {
    ...
    public String uploadFile(MultipartFile filePart, final String bucketName) throws IOException
    {
        ...
        final String fileNmae = dtString + "-" + filePart.getOriginalFilename();
        ...
        BlobInfo blobInfo =
                storage.create(
                        BlobInfo
                                .newBuilder(bucketName, fileNmae)
                        //Mofify access lost to allow all users with link to read file
                                .setAcl(new
